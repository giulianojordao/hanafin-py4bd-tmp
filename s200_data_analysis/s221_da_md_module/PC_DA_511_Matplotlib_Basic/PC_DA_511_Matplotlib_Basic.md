...
# images
PLT_01 ='images/PLT_01_screening.png'     # 현재상영작
```
...
```
    ...
    i                        int         1
    j                        int         2
    make_simple_line_chart   function    <function make_simple_lin<...>rt at 0x000001F3D84D0F28>
    math                     module      <module 'math' (built-in)>
    movies                   list        n=10
    np                       module      <module 'numpy' from 'C:\<...>ges\\numpy\\__init__.py'>
    pd                       module      <module 'pandas' from 'C:<...>es\\pandas\\__init__.py'>
    plt                      module      <module 'matplotlib.pyplo<...>\\matplotlib\\pyplot.py'>
    rc                       function    <function rc at 0x000001F3D480A620>
    reference                function    <function <lambda> at 0x000001F3D74A77B8>
